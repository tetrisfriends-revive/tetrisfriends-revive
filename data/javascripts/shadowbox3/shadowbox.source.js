...
(function(){
    ...
    function adjustHeight(height, top, anim, cb){
        var sb = U.get('sb-body'),
            sb_l = U.get('shadowbox_l');
            sb_r = U.get('shadowbox_r');
            st_i = U.get('sb-title-inner');
            s = U.get('sb-wrapper'),
            h = parseInt(height),
            t = parseInt(top);
            h_offset = 0;
        ...
        if(anim){
            U.animate(sb_l, 'height', h + h_offset, S.options.resizeDuration);
            U.animate(sb_r, 'height', h + h_offset, S.options.resizeDuration);
            U.animate(sb, 'height', h, S.options.resizeDuration);
            U.animate(s, 'top', t, S.options.resizeDuration, cb);
        }else{
            sb_l.style.height = h + h_offset + 'px';
