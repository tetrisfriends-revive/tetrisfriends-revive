...
var Tetris = (function() {
  ...
  this.init = function(params) {
      ...
      if (!initComplete) {
          ...
          if (config.flash.reviewLink.length > 0) {
              config.flash.reviewLink = "apps.facebook.com/tetrisbattlerevival" + config.appID + config.flash.reviewLink
          }
          if (config.flash.discussionLink.length > 0) {
              config.flash.discussionLink = "apps.facebook.com/tetrisbattlerevival" + config.appID + config.flash.discussionLink
          }
  ...
  this.detectZoom = function() {
      try {
          ...
          FB.log("Error detecting browser zoom")
      }
  };
  ...
  this.initAdvertisements = function() {
      FB.log("initAdvertisements - init");
      try {
  ...
  this.initAdvertisementsComplete = function() {
      FB.log("initAdvertisementsComplete");
      try {
  ...
  this.initSponsorPayEnergy = function() {
      if (!initSponsorPayEnergyComplete) {
          ...
          FB.log("initSponsorPayEnergyComplete");
          var callback = function(response) {
              initSponsorPayJSComplete = true;
              var appId = "5276";
              if (config.environment == "preproduction") {
  ...
  this.initSponsorPayArmor = function() {
      if (!initSponsorPayArmorComplete) {
          ...
          FB.log("initSponsorPayArmorComplete");
          var callback = function(response) {
              initSponsorPayJSComplete = true;
              var appId = "5276";
              if (config.environment == "preproduction") {
  ...
  this.initSponsorPayGatcha = function() {
      if (!initSponsorPayGatchaComplete) {
          ...
          FB.log("initSponsorPayGatchaComplete");
          var callback = function(response) {
              initSponsorPayJSComplete = true;
              var appId = "5276";
              if (config.environment == "preproduction") {
  ...
  this.exAfterUserSettings = function(fpc, fis, fic, pc, coins, exp, level, l, eaLevel) {
      ...
      var st3 = (FB._isHttps() ? "HTTPS" : "HTTP");
  ...
  this.exGameEnded = function(params) {
      ...
      if (Tetris.interstitialEnabled) {
          try {
              FB.log(Tetris.interstitialIntervals);
  ...
  this.exGetElapsedFriends = function() {
      FB.log("exGetElapsedFriends: " + Tetris.config.elapsedFriends);
      ...
      setTimeout(function() {
          $.ajax({
              ...
              success: function(response) {
                  FB.log(JSON.stringify(response));
                  if (response.locale) {
  ...
  this.finalizeGiftSend = function(apiUrl, params) {
      ...
      $.ajax({
          ...
          success: function(response) {
              try {
                  FB.log("Calling onSendGiftComplete");
                  Tetris.flashObject = Tetris.util.getFlashObject();
                  Tetris.flashObject.onSendGiftComplete(params.recipientList)
              } catch (ex) {
                  FB.log("Failure calling onSendGiftComplete");
                  FB.log(ex.message)
              }
              Tetris.tabClick("main")
          },
  ...
  this.trackEvent = function(userId, eventName, optionalParams, successCallback, validationErrorCallback) {
      ...
      if (FB && FB.AppEvents) {
          ...
          try {
              ...
              FB.log("[ERROR] Could not log AppEvent: " + ex.message)
          }
      }
  };
...
Tetris.api = (function() {
  ...
  this.videoOnOpen = function(id) {
      ...
      try {
          FB.log("videoOnOpen - Calling flashObject.dealspotOnOpen - " + Tetris.api.videoAdId);
          Tetris.flashObject = Tetris.util.getFlashObject();
      ...
      if (Tetris.api.videoAdId > 0) {
          if (Tetris.api.videoAdRewardType == "energy" || Tetris.api.videoAdRewardType == "armor" || Tetris.api.videoAdRewardType == "gatcha") {
              FB.log("videoOnReward - Calling flashObject.dealspotItemComplete - " + Tetris.api.videoAdId);
              Tetris.flashObject = Tetris.util.getFlashObject();
              Tetris.flashObject.dealspotItemComplete(Tetris.api.videoAdId)
          }
      }
  }, this.dealspotHideFlash = function() {
      FB.log("dealspotHideFlash");
      videoOnOpen(1);
      $("#trialpay-banner").css({
          position: "relative",
          top: -99999
      ...
      FB.log("dealspotHideFlash6");
      videoOnOpen(28)
  }, this.dealspotShowFlash6 = function() {
      FB.log("dealspotShowFlash6");
      videoOnClose()
  }, this.dealspotItemComplete6 = function(obj) {
      FB.log("dealspotItemComplete6");
      try {
          Tetris.flashObject = Tetris.util.getFlashObject();
          Tetris.flashObject.dealspotNoticeUnavailable()
      } catch (ex) {}
      ...
      FB.log("dealspotItemAvailableCashNotice");
      ...
      FB.log("dealspotItemUnavailableCashNotice");
      try {
          Tetris.flashObject = Tetris.util.getFlashObject();
          Tetris.flashObject.dealspotNoticeUnavailable()
      } catch (ex) {
      ...
      FB.log("dealspotUnavailableCash");
      try {
          Tetris.flashObject = Tetris.util.getFlashObject();
  ...
  this.supersonicArmorIsAvailable = function() {
      FB.log("supersonicArmorIsAvailable - " + Tetris.api.supersonicArmorReady);
      return (Tetris.api.supersonicArmorReady ? "1" : "0")
  };
  this.supersonicArmorOnOpen = function(id, rewardType) {
      FB.log("supersonicArmorOnOpen");
  ...
  this.sponsorpayOnOpen = function(id, rewardType) {
      FB.log("sponsorpayOnOpen - " + rewardType);
  ...
  this.applifierOnReady = function() {
      FB.log("applifierOnReady");
      Applifier.impact.prepare(function(err, data) {
          FB.log("camp length" + data.campaigns.length);
          Tetris.flashObject = Tetris.util.getFlashObject();
          if (err) {
  ...
  this.applifierOnShow = function() {
      FB.log("applifierOnShow")
  };
  this.applifierOnClose = function() {
      FB.log("applifierOnClose");
      $(".ad-container > iframe").css({
          top: 0
      });
      videoOnClose();
  ...
  this.interstitialOnOpen = function(params) {
      ...
      if (($.inArray(Tetris.config.eaLevel, Tetris.interstitialIntervals.eaLevels) >= 0) && Tetris.config.level >= Tetris.interstitialIntervals.levelThreshold) {
          FB.log("interstitialOnOpen2");
          hideFlashCallback({
              state: "opened"
          });
          Tetris.api.videoAdVisible = true;
          var adUrl = "//" + Tetris.config.advertisingPartialURL + "interstitial1" + (FB._isHttps() ? "_ssl" : "") + ".html";
  ...
  this.optimaticOnOpen = function(params) {
      ...
      if (Tetris.optimaticOverride == true || ($.inArray(Tetris.config.eaLevel, Tetris.interstitialIntervals.eaLevels) >= 0) && Tetris.config.level >= Tetris.interstitialIntervals.levelThreshold) {
          ...
          Tetris.api.videoAdVisible = true;
          var adUrl = "//" + Tetris.config.advertisingPartialURL + "optimatic1" + (FB._isHttps() ? "_ssl" : "") + ".html";
  ...
  this.liveRailOnOpen = function(params) {
      FB.log("LiveRailOnOpen1");
      if (($.inArray(Tetris.config.eaLevel, Tetris.interstitialIntervals.eaLevels) >= 0) && Tetris.config.level >= Tetris.interstitialIntervals.levelThreshold) {
          FB.log("LiveRailOnOpen2");
          hideFlashCallback({
              state: "opened"
          });
          try {
          ...
          Tetris.api.videoAdVisible = true;
          var adUrl = "//" + Tetris.config.advertisingPartialURL + "liverail" + (Tetris.isLiveRailSpotXTest ? "2" : "1") + (FB._isHttps() ? "_ssl" : "") + ".html";
          var adModal = '<div id="interstitial-video-ad-modal"><div id="video-ad-content"><a id="interstitial-close-button" href="javascript:void(0)" onclick="interstitialOnClose(true)" style="display: none"></a><div id="interstitial-video-ad-sponser-message">' + Tetris.lang.strings.textfields_intStaticAdTitle + '</div><iframe id="interstitial-video-ad-modal-iframe" scrolling="no" frameborder="0" style="border: 1px solid #ccc; overflow: hidden;" allowTransparency="true"></iframe><br /><div id="interstitial-ad-message-container" style="display:none"><div id="interstitial-video-ad-message" style="display:none">' + Tetris.lang.strings.textfields_intStaticAdUpsell + '</div></div><div id="interstitial-message">...Loading...</div><div class="clear"></div></div></div>';
          $("body").append(adModal);
          $("#interstitial-video-ad-modal").modal({
              opacity: 70,
  ...
  this.spotxOnOpen = function(params) {
      ...
      if (Tetris.spotxOverride || ($.inArray(Tetris.config.eaLevel, Tetris.interstitialIntervals.eaLevels) >= 0) && Tetris.config.level >= Tetris.interstitialIntervals.levelThreshold) {
          ...
          Tetris.api.videoAdVisible = true;
          var adUrl = "//" + Tetris.config.advertisingPartialURL + "spotx1" + (FB._isHttps() ? "_ssl" : "") + ".html";
          var adModal = '<div id="interstitial-video-ad-modal"><div id="video-ad-content"><a id="interstitial-close-button" href="javascript:void(0)" onclick="interstitialOnClose(true)" style="display: none"></a><div id="interstitial-video-ad-sponser-message">' + Tetris.lang.strings.textfields_intStaticAdTitle + '</div><iframe id="interstitial-video-ad-modal-iframe" scrolling="no" frameborder="0" style="border: 1px solid #ccc; overflow: hidden;" allowTransparency="true"></iframe><br /><div id="interstitial-ad-message-container" style="display:none"><div id="interstitial-video-ad-message" style="display:none">' + Tetris.lang.strings.textfields_intStaticAdUpsell + '</div></div><div id="interstitial-message">...Loading...</div><div class="clear"></div></div></div>';
          $("body").append(adModal);
          $("#interstitial-video-ad-modal").modal({
              opacity: 70,
  ...
  this.lifestreetOnOpen = function(params) {
      ...
      if (Tetris.lifestreetOverride || ($.inArray(Tetris.config.eaLevel, Tetris.interstitialIntervals.eaLevels) >= 0) && Tetris.config.level >= Tetris.interstitialIntervals.levelThreshold) {
          ...
          Tetris.api.videoAdVisible = true;
          var adUrl = "//" + Tetris.config.advertisingPartialURL + "lifestreet1" + (FB._isHttps() ? "_ssl" : "") + ".html";
          var adModal = '<div id="interstitial-video-ad-modal"><div id="video-ad-content"><a id="interstitial-close-button" href="javascript:void(0)" onclick="interstitialOnClose(true)" style="display: none"></a><div id="interstitial-video-ad-sponser-message">' + Tetris.lang.strings.textfields_intStaticAdTitle + '</div><iframe id="interstitial-video-ad-modal-iframe" scrolling="no" frameborder="0" style="border: 1px solid #ccc; overflow: hidden;" allowTransparency="true"></iframe><br /><div id="interstitial-ad-message-container" style="display:none"><div id="interstitial-video-ad-message" style="display:none">' + Tetris.lang.strings.textfields_intStaticAdUpsell + '</div></div><div id="interstitial-message">...Loading...</div><div class="clear"></div></div></div>';
          $("body").append(adModal);
          $("#interstitial-video-ad-modal").modal({
              opacity: 70,
  ...
  this.houseOnOpen = function(params) {
      ...
      if (Tetris.houseOverride || ($.inArray(Tetris.config.eaLevel, Tetris.interstitialIntervals.eaLevels) >= 0) && Tetris.config.level >= Tetris.interstitialIntervals.levelThreshold) {
          ...
          Tetris.api.videoAdVisible = true;
          var adUrl = "//" + Tetris.config.advertisingPartialURL + "house1" + (FB._isHttps() ? "_ssl" : "") + ".html";
          var adModal = '<div id="interstitial-video-ad-modal"><div id="video-ad-content"><a id="interstitial-close-button" href="javascript:void(0)" onclick="interstitialOnClose(true)" style="display: none"></a><div id="interstitial-video-ad-sponser-message">' + Tetris.lang.strings.textfields_intStaticAdTitle + '</div><iframe id="interstitial-video-ad-modal-iframe" scrolling="no" frameborder="0" style="border: 1px solid #ccc; overflow: hidden;" allowTransparency="true"></iframe><br /><div id="interstitial-ad-message-container" style="display:none"><div id="interstitial-video-ad-message" style="display:none">' + Tetris.lang.strings.textfields_intStaticAdUpsell + '</div></div><div id="interstitial-message">...Loading...</div><div class="clear"></div></div></div>';
          $("body").append(adModal);
          $("#interstitial-video-ad-modal").modal({
              opacity: 70,
  ...
  this.getAppFriends = function(nextCursor) {
      ...
      if (nextCursor != null) {
          FB.api("me/friends?fields=id,name&after=" + nextCursor, function(response) {
  ...
  this.checkIsAppFriend = function(friendId, callback) {
      FB.api("/me/friends/" + friendId + "?fields=id,name", function(response) {
          callback(response)
      })
  };
  ...
  this.checkInstalledFriends = function() {
      ...
      if (Tetris.config.appFriends != null && Tetris.config.appFriends.length > 0) {
          ...
          $.ajax({
              type: "GET",
              url: "localhost/xampp/Tetris%20Battle/tbc.tetrisfb.com/api/user/installedFriends" + Tetris.config.apiUrl + "localhost/xampp/Tetris%20Battle/tbc.tetrisfb.com/api/user/installedFriends",
              data: params,
              success: function(response) {
                  if (response.friends) {
                      Tetris.config.elapsedFriends = response.friends.join(",");
  ...
  this.checkThirdPartyId = function() {
      ...
      FB.log("offersHideFlash");
      hideFlash();
      showPage();
      tabHold = true
  }, this.offersShowFlash = function() {
      FB.log("offersShowFlash");
      hidePage();
      showFlash();
      ...
      this.endStreamPublish = function(postID, exception, data) {
          if (publishConfig.doCallback) {
              FB.log("endStreamPublish doCallBack");
              Tetris.flashObject = Tetris.util.getFlashObject();
              if (typeof Tetris.flashObject.processComplete == "function") {
                  FB.log("endStreamPublish function exists");
      ...
      this.placeOrder = function(data, params) {
          ...
          FB.log(Tetris.util.getJSON(data));
          var purchaseObject = {
              method: "pay",
              action: "purchaseitem",
          ...
          FB.log("Place Order");
          FB.log(purchaseObject);
          FB.ui(purchaseObject, placeOrderCallback)
      };
      this.placeOrderCallback = function(data) {
          FB.log(data);
          if (data.payment_id && data.status == "completed") {
              FB.log("Order Successful");
              Tetris.hideFlash();
              Tetris.hidePage();
              ...
              FB.log("placeOrder() failure");
              FB.log("Error from Facebook: " + data.error_code);
              return false
          }
      };
      this.placeItemOrder = function(data) {
          ...
          FB.log("Place Order");
          FB.log(purchaseObject);
          FB.ui(purchaseObject, placeItemOrderCallback)
      };
  ...
  this.requests = (function() {
      ...
      this.get = function(id, callback) {
          FB.log("GET /" + id);
          FB.api("/" + id + "?fields=id,to,from,message,data,created_time", callback)
      };
      this.remove = function(id, callback) {
          FB.log("DELETE /" + id);
          FB.api("/" + id, "DELETE", callback)
      };
      ...
      this.sendGiftPiece = function(params, targetIds) {
          ...
          var uuid = FB.getKontagentApi().genUniqueTrackingTag();
          var targetIdsNew = [];
          var i;
          if (targetIds.length > 50) {
              ...
              Tetris.api.requests.send(title, message, Tetris.util.getJSON(data), ["all", "app_users"], null, targetIdsNew.toString(), function(response) {
                  FB.log("REQUEST DATA: " + Tetris.util.getJSON(response));
  ...
  this.activity = (function() {
      ...
      this.sendActivity = function(action, method, params) {
          FB.log("sendActivity");
          FB.log(new Array(action, method, params));
          Tetris.api.checkPermission("publish_actions", function(isAllowed) {
              if (isAllowed) {
                  FB.log("Publish Allowed");
                  FB.api("/me/" + config.appNamespace + ":" + action, method, params)
              }
          }, false)
      };
      return this
  ...
  this.checkPermission = function(permission, callback, requestPermission, forceRequest) {
      ...
      FB.api("/" + config.userID + "/permissions?fields=permission,status", function(response) {
          var isAllowed = false;
          if (response.data) {
          ...
          if (isAllowed) {
              FB.log("Permission Allowed - " + permission);
              callback(true)
          } else {
              var cookie = getCookie("fb_" + permission + config.userID);
              FB.log("Permission Not Allowed - " + permission + ", cookie: " + cookie + ", requestPermission: " + requestPermission);
...
KontagentApi.prototype._imageCallback = function(a) {
  FB._ktApi._isSendingMessage = false;
...
primeKontagentFacebookSDK = function() {
  ...
  FB.ui = function(f, a) {
      var e = a;
      var c = FB.getAuthResponse();
      if (c && c.userID) {
          switch (f.method.toLowerCase()) {
              case "apprequests":
                  var b = FB._ktApi.genUniqueTrackingTag();
                  f.data = FB._appendKtVarsToDataField(f.data, {
                      kt_track_inr: 1,
                      kt_u: b,
                      kt_st1: f.subtype1,
                      kt_st2: f.subtype2,
              ...
              case ("feed"):
                  var b = FB._ktApi.genUniqueTrackingTag();
                  if (f.link) {
                      f.link = FB._appendKtVarsToUrl(f.link, {
                          kt_track_psr: 1,
                          kt_u: b,
                          kt_st1: f.subtype1,
                          kt_st2: f.subtype2,
                  ...
                  if (f.actions && f.actions.length && f.actions.length > 0) {
                      for (var d = 0; d < f.actions.length; d++) {
                          if (f.actions[d]["link"]) {
                              f.actions[d]["link"] = FB._appendKtVarsToUrl(f.actions[d]["link"], {
                                  kt_track_psr: 1,
                                  kt_u: b,
                                  kt_st1: f.subtype1,
                                  kt_st2: f.subtype2,
  ...
  FB._perform_redirect = function() {
      if (FB._ktApi._isSendingMessage) {
          FB.log("sending msg");
          setTimeout(FB._perform_redirect(), 100)
      } else {
          setTimeout("top.location.href = kt_redirect;", 1000)
      }
  };
  FB._trackLandingBeforeRedirect = function() {
      if (KT_SEND_CLIENT_SIDE) {
          if (KT_GET.kt_track_inr) {
              FB.log("kt_track_invite");
          ...
          if (window.kt_redirect && !KT_USE_JS_LOGIN) {
              FB._perform_redirect()
          }
      }
  };
  FB._trackLandingAfterRedirect = function() {
      ...
      if (b && b.userID) {
          ...
          if (KT_GET.fb_appcenter || (KT_GET.kt_track_apa && KT_GET.code && !KT_GET.error)) {
              var a = FB._ktApi.genInstalledCookie(Tetris.config.appId, b.userID);
              if (!getCookie(a)) {
  ...
  FB._trackInviteSent = function(a, b) {
  ...
  FB._trackUserInformation = function(d, a) {
      var c, b;
      if (d) {
          c = d.substring(0, 1)
      }
  ...
  FB._trackSpruce = function() {
      KT_GET.spruce_adid && FB._ktApi._sendHttpRequestViaImgTag(window.location.protocol + "https://bp-pixel.sprucemedia.com/100480/pixel.ssps?spruce_adid=" + KT_GET.spruce_adid + "&spruce_sid=" + FB._ktApi.genShortUniqueTrackingTag())
  };
  FB._isArray = function(a) {
  ...
  FB._appendKtVarsToDataField = function(b, c) {
      b += "|";
      for (var a in c) {
      ...
      return FB._removeTrailingAmpersand(b)
  };
  FB._appendKtVarsToUrl = function(a, c) {
      if (a.indexOf("?") == -1) {
          a += "?"
      } else {
          a += "&"
      ...
      return FB._removeTrailingAmpersand(a)
  };
  FB._removeTrailingAmpersand = function(a) {
...
Tetris.util = (function() {
  ...
  this.getJQuery = function() {
      var result = $;
      if (!$.toJSON || !$.modal) {
          FB.log("toJSON or modal missing - returning internal jQuery");
...
/*
   FILE ARCHIVED ON 02:33:18 Jun 01, 2019 AND RETRIEVED FROM THE
   INTERNET ARCHIVE ON 21:07:32 Oct 22, 2019.
...
/*
playback timings (ms):
load_resource: 111.066
xauthn.chkprivs: 0.091
LoadShardBlock: 69.442 (3)
captures_list: 247.928
esindex: 0.013
PetaboxLoader3.resolve: 65.107
PetaboxLoader3.datanode: 86.631 (4)
xauthn.identify: 149.739
RedisCDXSource: 1.327
CDXLines.iter: 22.291 (3)
exclusion.robots.policy: 150.277
exclusion.robots: 150.297
*/